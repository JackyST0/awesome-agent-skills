...
- [birdview](https://github.com/Qiuner/birdview) - Treat architecture and constraints as the enduring work of programming, making both reviewable before AI writes code.
