...
- [job-application-agent](https://github.com/vaibhavarora14/job-application-agent) - Privacy-first skill + CLI to discover, qualify, complete, and track your own job applications.
