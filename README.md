...
- [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) - X/Twitter data skill with MCP server, REST API, 20 extraction tools, and account monitoring.
